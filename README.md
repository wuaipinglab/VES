...
The training and evaluation steps are provided in this repository, with data and model checkpoints uploaded to [Zenodo](https://zenodo.org/records/22790015). Quantitative evaluation results can be found at "sampled_evaluation" folder, and model predictions for detailed analysis with more experimental data (evaluation data) are uploaded at "results/model_prediction_with_exp_data" for reference. 
