...
from Diffusion_Model_Unet_COVID_4_conv import UNetScoreBasedDiffusionModel
from utils import data_utils_COVID
...
if __name__=='__main__':
    ...
    parser.add_argument('--protein_index', default=1, type=int, help='Row index of protein in input mapping file')
    ...
    parser.add_argument('--model_name_suffix', default='COVID_DM_UNet_Attention_4_conv_data_update', type=str, help='model checkpoint name will be the protein name followed by this suffix')
    ...
    data = data_utils_COVID.MSA_processing(
    ...
    torch.save(model.state_dict(), './results/Diffusion_model/COVID_DM_UNet_Attention_4_conv_data_update.pth')
