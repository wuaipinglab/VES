...
from Diffusion_Model_Unet_attention_Blosum import UNetScoreBasedDiffusionModel
from utils import data_utils_BLOSUM
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description='VES with BLOSUM restriction')
    ...
    parser.add_argument('--model_name_suffix', default='Dec1_FLU_DM_UNet_Attention_Blosum', type=str, help='model checkpoint name will be the protein name followed by this suffix')
    ...
    data = data_utils_BLOSUM.MSA_processing(
    ...
    x_train = data.one_hot_encoding + data.blosum_encoding
    best_val_loss = None
    ...
    torch.save(model.state_dict(), './results/Diffusion_model/Dec3_FLU_DM_UNet_Attention_Blosum.pth')
